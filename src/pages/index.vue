...
.v-pagination__item--is-active {
  ...
  border-radius: 4px;
  box-shadow:
    0 5px 5px rgba(255, 255, 255, 0.8),
    0 9px 10px rgba(255, 255, 255, 0.76),
    0 5px 14px rgba(255, 255, 255, 0.88);
  transition: 0.7s;
}
...
.v-pagination__item {
  ...
  box-shadow:
    ...
    0 2px 2px rgba(255, 255, 255, 0.76),
    0 1px 5px rgba(255, 255, 255, 0.88);
}
</style>
